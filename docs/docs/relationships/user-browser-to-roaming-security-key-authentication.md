---
id: user-browser-to-roaming-security-key-authentication
title: User Browser To Roaming Security Key Authentication
---
...
## Controls
        ...
        Roaming key authentication requires user verification and origin/RP binding.
